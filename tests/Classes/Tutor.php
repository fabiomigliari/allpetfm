...
class Tutor extends People{
    ...
    public function __construct($pdo, int $id_tutor, bool $status, string $dtregistro, string $nome, string $dt_nasc, string $rg, string $cpf, string $email, string $telefone, int $tipo, Address $endereco)
    {   
        $this->pdo = $pdo;

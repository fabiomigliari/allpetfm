                                    ...
                                    <div class="modal-content p-3">
                                        ...
                                        <div class="mt-3">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                              <li class="nav-item">
                                                <a class="nav-link active" id="pessoa-tab" data-bs-toggle="tab" href="#pessoa" role="tab" aria-controls="pessoa" aria-selected="true">Pessoa</a>
                                              </li>
                                                ...
                                                <div class="container mt-5 mb-5">
                                                  ...
                                                  <div class="container mt-4 mb-5">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <div class="ml-auto">
                                                        <button type="submit" class="btn btn-primary btn-circle"><i class="fas fa-fw fa-chevron-right"></i></button>
                                                        </div> 
                                              ...
                                              <div class="tab-pane fade" id="endereco" role="tabpanel" aria-labelledby="endereco-tab">
                                                ...
                                                <div class="container mt-4 mb-4">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <button type="button" id="voltar" class="btn btn-primary btn-circle"><i class="fas fa-fw fa-chevron-left"></i></button>
                                                        <div class="ml-auto">
                                                        <a href="contutor2.html" class="btn btn-success btn-circle"><i class="fas fa-fw fa-chevron-down"></i></a>
                                                        <a href="contutor.html" class="btn btn-danger btn-circle"><i class="fas fa-fw fa-xmark"></i></a>
                                                        </div> 

...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <nav
            ...
            <h5 class="text-primary">Serviços - Alterar</h5>
            <!-- Topbar Navbar -->
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="servico-tab" data-bs-toggle="tab" href="#servico"
                               role="tab" aria-controls="servico" aria-selected="true">Alterar serviço</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="servico" role="tabpanel"
                                ...
                                <div class="col mb-3">
                                    <form method="post" action="">
                                        <label for="nomeservico" class="form-label"><b>Nome do
                                                Serviço</b></label>
                                        <input value="<?=$obServico->nomeservico?>" type="text" class="form-control" id="nomeservico" name="nomeservico"
                                               placeholder="Digite o nome do Serviço">
                                </div>
                                <div class="col mb-3">
                                    <label for="duracao" class="form-label"><b>Duração</b></label>
                                    <input value="<?=$obServico->duracao?>" type="text" class="form-control" id="duracao" name="duracao"
                                           placeholder="Digite a duração do Serviço">
                                </div>
                                <div class="col mb-2">
                                    <label for="preco" class="form-label"><b>Preço</b></label>
                                    <input value= "R$ <?=$obServico->preco?>,00" type="text" class="form-control" id="preco" name="preco"
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                    ...
                                    <select class='form-control' name='fluxoag' id="fluxoag">
                                        <option value=' "<?=$obServico->fluxoag?>" '>Selecione...</option>
                                ...
                                <div class="col mb-3">
                                    <label for="periodorec" class="form-label"><b>Período
                                            Recomendado</b></label>
                                    <input value="<?=$obServico->periodorec?>"  type="text" class="form-control" id="periodorec" name="periodorec"
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="modatend" class="form-control" id="modatend" rows="5"
                                                  placeholder="Descreva aqui como funciona o serviço"><?=$obServico->modatend?> </textarea>
                        ...
                        <div class="container mt-4 mb-5">
                            <button type="submit" name="editar" class= "btn btn-danger btn-sm-2">Editar</button>
